...
![Report Title](images/dashboard_01_title.png)
...
![Semantic Model](images/dashboard_02_semantic_model.png)
...
![Transformations](images/dashboard_03_transformations.png)
...
![Rate Cycles](images/dashboard_04_rate_cycles.png)
...
![Sector Performance - COVID Crash](images/dashboard_05_capital_rotation_covid.png)
![Sector Performance - Financial Crisis](images/dashboard_06_capital_rotation_financial_crisis.png)

**Crisis-Era Company Funding** — drill-through by crisis event, showing first-round VC funding by sector and company outcome.
![Crisis Funding - Dot-com](images/dashboard_07_crisis_funding_dotcom.png)
![Crisis Funding - Financial Crisis](images/dashboard_08_crisis_funding_financial.png)

**Shifting Ground** — rising federal interest costs and the dollar/gold divergence as a signal of ongoing capital rotation.
![Shifting Ground](images/dashboard_09_shifting_ground.png)
...
![Playbook](images/dashboard_10_playbook.png)
...
[![Transformations Diagram](images/transformations.png)](images/transformations.png)
...
├── images/
│   ├── dashboard_01_title.png    # Report title page
│   ├── dashboard_02_semantic_model.png
│   ├── dashboard_03_transformations.png
│   ├── dashboard_04_rate_cycles.png
│   ├── dashboard_05_capital_rotation_covid.png
│   ├── dashboard_06_capital_rotation_financial_crisis.png
│   ├── dashboard_07_crisis_funding_dotcom.png
│   ├── dashboard_08_crisis_funding_financial.png
│   ├── dashboard_09_shifting_ground.png
│   ├── dashboard_10_playbook.png
